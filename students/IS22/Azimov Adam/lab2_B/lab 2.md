...
- Загружена модель model_final.onnx.
- Загружено изображение image.png (кролик).
- Модель корректно предсказала класс “RABBIT” с высокой уверенностью.
- Проверена устойчивость к сдвигам: предсказания остаются стабильными при небольших перемещениях изображения.

Результат тестирования
![alt text](images/onnx_1.png)
